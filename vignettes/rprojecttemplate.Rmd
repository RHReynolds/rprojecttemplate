...
Personally, I believe all data analyses should be hosted on Github -- both for reproducibility, but also for your own version control. 
...
1. Create a Github repository on the Github website, as detailed in this [guide](https://docs.github.com/en/get-started/quickstart/create-a-repo).
...
rprojecttemplate::setup_project(new_project_path)
```
