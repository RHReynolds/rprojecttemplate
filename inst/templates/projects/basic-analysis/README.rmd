...
*TODO: If you want to be able to view `docs/` interactively, you will need to set up [github pages](https://pages.github.com/) -- this is incredibly easy and fast to do. Remember to change the folder from which the Github Pages site is built to `docs/`.*
